...
import { Loader2, Mail, Lock, User, CheckCircle, AlertCircle, Zap, Shield, TrendingDown, ArrowLeft } from 'lucide-react';
import { z } from 'zod';
...
export default function Auth() {
  ...
  // Reset password email sent success view
  if (resetEmailSent) {
    return (
        ...
        <Card className="w-full max-w-md animate-scale-in relative backdrop-blur-sm bg-card/95 border-border/50 shadow-xl">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription className="text-base mt-2">
              Jeśli konto z podanym adresem e-mail istnieje, wysłaliśmy na nie link do zresetowania hasła. 
        ...
        <div className="w-full max-w-md space-y-6 animate-slide-up">
          ...
          <Card className="backdrop-blur-sm bg-card/95 border-border/50 shadow-xl">
            <CardHeader className="text-center pb-4">
              <CardTitle className="text-2xl font-display">Resetowanie hasła</CardTitle>
